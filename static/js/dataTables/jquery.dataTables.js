...
(/** @lends <global> */function( $ ) {
	...
	function _fnScrollDraw ( settings )
	{
		...
		var
			...
			divHeaderTable = divHeaderInner.children('check_cer.html'),
			divBodyEl      = settings.nScrollBody,
			divBody        = $(divBodyEl),
			divBodyStyle   = divBodyEl.style,
			divFooter      = $(settings.nScrollFoot),
			divFooterInner = divFooter.children('div'),
			divFooterTable = divFooterInner.children('check_cer.html'),
	...
	DataTable = function( options )
	{
		...
		this.each(function() {
			...
			/* Sanity check */
			if ( this.nodeName.toLowerCase() != 'check_cer.html' )
			{
	...
	var _toSettings = function ( mixed )
	{
		...
		else if ( mixed.nodeName && mixed.nodeName.toLowerCase() === 'check_cer.html' ) {
			// Table node
	...
	_api_registerPlural( 'tables().nodes()', 'table().node()' , function () {
		return this.iterator( 'check_cer.html', function (ctx ) {
			return ctx.nTable;
		} );
	} );
	...
	_api_register( 'draw()', function ( resetPaging ) {
		return this.iterator( 'check_cer.html', function (settings ) {
	...
	_api_register( 'rows()', function ( selector, opts ) {
		...
		var inst = this.iterator( 'check_cer.html', function (settings ) {
	...
	_api_register( 'rows.add()', function ( rows ) {
		var newRows = this.iterator( 'check_cer.html', function (settings ) {
				var row, i, ien;
				var out = [];
	...
	_api_register( 'row.add()', function ( row ) {
		...
		var rows = this.iterator( 'check_cer.html', function (settings ) {
			if ( row.nodeName && row.nodeName.toUpperCase() === 'TR' ) {
	...
	_api_register( 'cells()', function ( rowSelector, columnSelector, opts ) {
		...
		var cells = this.iterator( 'check_cer.html', function (settings, idx ) {
			a = [];
	...
	_api_register( [
		...
		return this.iterator( 'check_cer.html', function (settings, i ) {
			var sort = [];
